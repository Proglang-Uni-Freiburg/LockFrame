...
public:
    ...
    void get_races()
    {
        ...
        this->lockframe->report_statistic("Threads", this->threads.size());
        ...
        this->lockframe->report_statistic("EXTRAEDGES dependencies sum", extra_dependency_count);
        this->lockframe->report_statistic("EXTRAEDGES dependencies per thread", extra_dependency_per_thread_count);

        this->lockframe->report_statistic("reads", this->read_events_counter);
        this->lockframe->report_statistic("writes", this->write_events_counter);
        this->lockframe->report_statistic("acquires", this->acquire_events_counter);
        this->lockframe->report_statistic("releases", this->release_events_counter);
        this->lockframe->report_statistic("forks", this->fork_events_counter);
        this->lockframe->report_statistic("joins", this->join_events_counter);
        this->lockframe->report_statistic("notifies", this->notify_events_counter);
        this->lockframe->report_statistic("waits", this->wait_events_counter);
        this->lockframe->report_statistic("locks", this->locks.size());

        this->lockframe->report_statistic("VC limit exceeded", this->vc_limit_exceeded_counter);
        this->lockframe->report_statistic("VC limit exceeded by dependency", this->vc_limit_exceeded.size());
#endif
    }
};